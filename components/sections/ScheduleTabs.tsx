      ...
      <div className="mb-12 flex gap-0 overflow-x-auto border-b border-[rgba(10,186,181,0.12)]">
        {groups.map((g) => (
          <button
            ...
            className={cn(
              'whitespace-nowrap px-6 py-3.5 text-[10px] font-medium uppercase tracking-[0.16em]',
          ...
          {activeClasses.map((row) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-[18px] text-[13.5px] font-medium text-[#f1f5f9]">{row.name}</td>
                <td className="py-[18px] text-[12px] text-[#cbd5e1]">{instructorLine(row)}</td>
                <td className="py-[18px] text-[10px] uppercase tracking-[0.12em] text-[#cbd5e1]">
                  {row.ageRangeDisplay}
                </td>
