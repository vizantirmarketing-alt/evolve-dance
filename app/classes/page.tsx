...
export default function ClassesPage() {
  return (
    <div className="min-h-screen bg-[#070a09]">
      ...
      <section className="w-full bg-[#070a09] pt-[140px] pb-20 md:pb-28 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center py-4 px-8 text-[11px] font-semibold tracking-[0.15em] uppercase text-black bg-[#2DD4BF] no-underline transition-colors hover:bg-[#3ef0d8] text-center [clip-path:polygon(10px_0%,100%_0%,calc(100%-10px)_100%,0%_100%)]"
            >
              Book a Free Trial
            </Link>
            <Link
              href="/classes#schedule"
              className="inline-flex items-center justify-center py-4 px-8 text-[11px] font-semibold tracking-[0.15em] uppercase text-[#f0faf8] border border-[rgba(45,212,191,0.25)] bg-transparent no-underline transition-colors hover:border-[#2DD4BF] hover:text-[#2DD4BF] text-center"
            >
              View Schedule
            </Link>
          </div>
      ...
      <section
        id="classfinder"
        className="w-full bg-[#070a09] scroll-mt-[140px] border-t border-[rgba(45,212,191,0.08)]"
      >
      ...
      {/* 3. All styles grid */}
      <section className="w-full bg-[#070a09] px-6 md:px-12 py-20 md:py-28 border-t border-[rgba(45,212,191,0.08)]">
      ...
      {/* 5. Bottom CTA */}
      <section className="w-full bg-[#2DD4BF] px-6 md:px-12 py-20 md:py-24">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center py-4 px-8 text-[11px] font-semibold tracking-[0.15em] uppercase text-[#2DD4BF] bg-[#070a09] no-underline transition-opacity hover:opacity-90 [clip-path:polygon(10px_0%,100%_0%,calc(100%-10px)_100%,0%_100%)]"
          >
            Book a Free Trial
          </Link>
        </div>
