      ...
      <main className="min-h-screen bg-background px-4 pb-32 pt-24 md:px-12 md:pt-28">
        <div className="mx-auto max-w-3xl">
          ...
          <article className="font-sans">
            ...
            <p className="mt-4 text-[15px] font-light leading-[1.8] text-foreground">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-[15px] font-light leading-[1.8] text-foreground">
